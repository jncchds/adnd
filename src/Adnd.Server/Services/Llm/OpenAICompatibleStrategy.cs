...
/// <summary>
/// Formats requests for any OpenAI-compatible /v1/chat/completions endpoint.
/// Identical to OpenAI strategy but accepts a configurable endpoint prefix.
/// </summary>
public sealed class OpenAICompatibleStrategy : IAdndLlmStrategy
{
